...
#include <string.h>
#include <limits.h>
#include "./includes/ft_printf.h"  // ou declara ft_printf aqui se não tiveres header
...
void    run_test(const char *format, ...)
{
    ...
    ret_ft_printf = vsnprintf(ft_printf_buff, sizeof(ft_printf_buff), format, args2); // Se o teu ft_printf suportar va_list
